...
%\usepackage[paperheight=12.5cm,left=1cm,right=1cm,top=-2cm,bottom=-1cm]{geometry}
...
\hypersetup{pdftitle={Ví dụ cách đánh số cho các phần, các chương và các mục trong lớp book},
	...
	pdfkeywords={latex, book, part, chapter, section, subsection, subsubsection, subsubsubsection, paragraph, subparagraph},
	bookmarks=true,
	bookmarksopen=true
}
